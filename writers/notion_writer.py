...
class NotionWriter(BaseWriter):
    ...
    # TODO: Créer ou mettre à jour une page "Citations" dans la database Notion "Citations".
    ...
    # TODO: Pour chaque personnage dans data["personnages"], créer une page
    # dans la database Notion "Personnages" si elle n'existe pas déjà (recherche
    # par nom exact). Propriétés : nom (title), description (rich_text),
    # livre (relation vers DB Livres), auteur (relation vers DB Auteurs).
